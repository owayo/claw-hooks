...
* **Built-in Tools**: You can match any built-in tool (e.g., `read_file`, `run_shell_command`). See the [Tools Reference](https://geminicli.com/docs/tools) for a full list of available tool names.
