...
- **Code in Diagnostics**: Whitespace in line-numbered source excerpts and unified-diff code lines (including context) is preserved, so indentation and string literals shown to the agent match the actual code
